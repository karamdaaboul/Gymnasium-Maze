...
try:
    ...
    from gymnasium_maze.utils import mujoco_py_utils
...
try:
    ...
    from gymnasium_maze.utils import mujoco_utils
except ImportError as e:
...
class MujocoPyRobotEnv(BaseRobotEnv):
    ...
    def __init__(self, **kwargs):
        ...
        Raises:
            error.DependencyNotInstalled: if mujoco_py bindings are not installed. Install with `pip install gymnasium-maze[mujoco-py]`
        """
