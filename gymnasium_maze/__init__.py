...
from gymnasium_maze.envs.maze import maps
    ...
    for reward_type in ["sparse", "dense"]:
        ...
        for version in ["v3", "v4", "v5"]:
            register(
                ...
                entry_point=f"gymnasium_maze.envs.maze.ant_maze_{version}:AntMazeEnv",
        ...
        register(
            ...
            entry_point="gymnasium_maze.envs.maze.point_maze:PointMazeEnv",
            kwargs=_merge({"maze_map": maps.U_MAZE}, kwargs),
